 ...
 * @author Djapac
 */
public class UcitajListuRezervacija extends AbstractSO{
    
    private List<Rezervacija> listaRezervacija = new ArrayList<>();

    public UcitajListuRezervacija() throws Exception {
        super();
    }
    ...
    protected void executeOperation(Object object) throws Exception {
        List<DomainObject> domainObjects = databaseBroker.getAllWithDoubleInnerJoin((DomainObject) object);
